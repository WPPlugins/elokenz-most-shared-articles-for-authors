<?php
/*
  Plugin Name: Elokenz - Author's Most Shared Articles
  Description: Display authorship based 'most shared articles' in a <a href="widgets.php">widget</a>. Please, create an account on <a href="http://www.elokenz.com">Elokenz</a> to get your data collected prior using the widget (this feature is free and will always be).
...
# Add shortcode
add_shortcode( 'elokenz_widget', 'elokenz_widget_shortcode' );

function elokenz_widget_shortcode( $atts ) {
    ...
    $type = 'baw_elokenz_widget';
    //$width = $atts['width'];        
    $width = !$atts['width'] ? 'auto' : (int)$atts['width']."px";
    
    $args = array(
        'before_widget' => "<div style='width: $width ;'>",
        'after_widget'  => '</div>',
        'before_title'  => '',
        'after_title'   => '',
    );
